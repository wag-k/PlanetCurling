...
function main(_param) {
    ...
    scene.onLoad.add(function () {
        ...
        var launchGuide = new rendering_1.LaunchGuideView(scene, guideLayer, function () { return matchController.state === match_controller_1.MatchState.Aiming ? matchController.activeStone : undefined; }, game_balance_1.GameBalance.WorldSpanMeters);
        var hud = new game_hud_view_1.GameHudView(scene, font, matchController, renderer.trajectoryVisibility);
